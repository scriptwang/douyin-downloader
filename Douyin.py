...
def __run__():
    ...
    _p_len = util._get_post_request_data(_browser_,_config_,_result_)
    _browser_.quit()
    print('浏览器退出成功...')
    _l_len = util._get_like_request_data(_config_,_result_)
...
if __name__ == '__main__':
    ...
    r = __run__()
    print('Donyin下载任务结束... ...')
    print('视频下载完毕,发表的视频[' + str(r['l_len']) + ']条,喜欢的视频[' + str(r['p_len']) + ']条!')
